...
void HistoManager::Book()
{
  ...
  //22 For optical photons entering PMT
  analysisMan->CreateH1("PMTCountsperEvent", "Photons entering PMT in each Event ", n, xmn, xmx);
  //23 For Energy deposit per event
  analysisMan->CreateH1("PMTEnergy", "Photons Energy per event ", n, xmn, xmx);
  //24 For Initial Energy per event
  analysisMan->CreateH1("RecoilEnergy", "Initial Energy ", n, xmn, xmx);
  //25 For optical photons entering PMT
  analysisMan->CreateH1("PMTCounts", "Photons entering PMT ", n, xmn, xmx);
