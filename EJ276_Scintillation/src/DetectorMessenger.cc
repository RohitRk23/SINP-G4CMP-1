...
// * the Geant4 Collaboratio
// n.  It is provided  under  the terms  and *
  ...
  , fDetector(Det)
{
  ...
  // For Refelcting Surface 
  //----------------------------------------------------------------------------//
  //  fMirrorSurfaceMatPropVectorCmd =
  //   new G4UIcmdWithAString("/opnovice2/MirrorSurfaceProperty", this);
  // fMirrorSurfaceMatPropVectorCmd->SetGuidance("Set material property vector");
  // fMirrorSurfaceMatPropVectorCmd->SetGuidance(" for the mirror surface.");
  // fMirrorSurfaceMatPropVectorCmd->AvailableForStates(G4State_PreInit, G4State_Idle);
  // fMirrorSurfaceMatPropVectorCmd->SetToBeBroadcasted(false);
  //-----------------------------------------------------------------------------//
...
DetectorMessenger::~DetectorMessenger()
{
  ...
  // delete fMirrorSurfaceMatPropVectorCmd; // For Refelcting Surface
...
void DetectorMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  ...
  //-------------------------------------------------------------------//
  // else if(command == fMirrorSurfaceMatPropVectorCmd)
  // {
  //   // Convert string to physics vector
  //   // string format is property name, then pairs of energy, value
  //   // space delimited
  ...
  //     mpv->InsertValues(en, val);
  //   }
  //   fDetector->AddMirrorProperty(prop, mpv);
  // }
  //------------------------------------------------------------------//
